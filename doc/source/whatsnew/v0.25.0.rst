...
- Bug in the :meth:`~Interval.overlaps` method for :class:`Interval`, :class:`~arrays.IntervalArray`, and :class:`IntervalIndex` where empty ``Interval`` objects could incorrectly be marked as overlapping. (:issue:`26893`)
